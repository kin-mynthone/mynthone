part of '../localization/app_translations.dart';

final Map<String, String> _englishTranslationMap = {
  // Common
  'Continue': 'Continue',
  'Next': 'Next',
  'Sign In': 'Sign In',
  ...
  'The Digital wallet that connects global':
      'The Digital wallet that connects global',
  'Banking Beyond, Welcome to the super experience':
      'Banking Beyond, Welcome\nto the super experience',

  // Onboarding
  'Welcome to Secure Banking': 'Welcome to Secure Banking',
  'Experience the future of banking with our secure, innovative platform. Get started on your journey towards financial empowerment today.':
      'Experience the future of banking with our secure, innovative platform. Get started on your journey towards financial empowerment today.',
  'Seamless Account Setup': 'Seamless Account Setup',
